...
export default function QuickLinks() {
  return (
    <div className="text-center">
      ...
      <div className="font-semibold rounded-lg bg-yellow-200 2xl:hover:bg-yellow-100 shadow-md shadow-slate-400 mt-5">
        <Link href="/immigration-medical-exam"> Immigration Medical Exam </Link>
      </div>
    </div>
  );
}
