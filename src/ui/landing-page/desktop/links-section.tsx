...
export default function DesktopLinksSection() {
  return (
    <section className="h-screen flex flex-col items-center snap-start snap-always bg-hmblack">
      <div className="h-full w-screen flex flex-col items-center justify-between py-10">
        <div className="w-full px-1/12">
          <FloatingElement>
            <h1 className="text-center text-3xl lg:text-4xl xl:text-5xl font-bold pt-14 text-white">
              Clinic Hours
            </h1>
          </FloatingElement>
